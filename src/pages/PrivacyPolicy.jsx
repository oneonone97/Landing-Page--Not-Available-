      ...
      <div className="container">
        ...
        <div className="legal-content">
          <section className="legal-section">
            <h2>Introduction</h2>
            <p>
              This Privacy Policy describes how <strong>https://www.notavailable.co.in/</strong> <strong>Not Available</strong> and its affiliates (collectively "<strong>Not Available</strong>, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website (hereinafter referred to as <strong>Platform</strong>). Please note that you may be able to browse certain sections of the Platform without registering with us. We do not offer any product/service under this Platform outside India and your personal data will primarily be stored and processed in India. By visiting this Platform, providing your information or availing any product/service offered on the Platform, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service/product terms and conditions, and agree to be governed by the laws of India including but not limited to the laws applicable to data protection and privacy. If you do not agree please do not use or access our Platform.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p><strong>Designation:</strong> Abhishek Kumar Mishra</p>
            <p><strong>Address:</strong> PK-78, Sector - 122, Noida - 201301, Uttar Pradesh</p>
            <p><strong>Email:</strong> wesourceb2c@gmail.com</p>
            <p><strong>Phone:</strong> +91-7982572738 | Time: Monday - Friday(9:00 - 18:00)</p>
          </section>
        </div>
        <hr />
        <p>
