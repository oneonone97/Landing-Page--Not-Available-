      ...
      <div className="container">
        ...
        <div className="legal-content">
          <section className="legal-section">
            ...
            <p>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>https://www.notavailable.co.in/</strong> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            <p>
              The Platform is owned by <strong>Not Available</strong>, a company incorporated under the Companies Act, 1956 with its registered office at <strong>PK-78, Sector - 122, Noida - 201301, Uttar Pradesh</strong> (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
            </p>
          </section>
          ...
          <section className="legal-section">
            <h2>ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</h2>
            ...
            <ol>
              ...
              <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in <strong>Noida</strong> and <strong>Uttar Pradesh</strong>.</li>
